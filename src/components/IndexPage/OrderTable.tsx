  ...
  return (
      ...
      <Table.Body>
        ...
        <Table.Row key={order.id}>
          ...
          <Table.Cell>{order.delivery_date}</Table.Cell>
          ...
          <Table.Cell>{order.comment}</Table.Cell>
          {
            ...
            <Table.Cell>
              <ButtonGroup>
                <Button colorPalette={'blue'} onClick={()=>dispatch(cancelOrder(order.id))}>Отменить</Button>
                <Button colorPalette={'blue'} onClick={()=>dispatch(completeOrder(order.id))}>Завершить</Button>
              </ButtonGroup>
            </Table.Cell> : ''
          }
        </Table.Row>
